...
console.log(`Problem 1 result --> `, artists[0]);
console.log(`Problem 1 result --> `, artists[2].bio);

/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue and console.log() to check your work. */


artists[8].name = "Vincent Van Gogh";
console.log(`Problem 2 result --> `, artists[8]);
...
function getArtistByIndex(array, index) {
  ...
  console.log(`Problem 3 result --> `, getArtistByIndex(artists, 0));
  /**
...
for (let i = 0; i < artists.length; i++) {
  if(1900 <= artists[i].years.split('-')[0]){
    console.log(yearsLived.push(array[i].name))
  }//if
  }//for
  return yearsLived;
}//function

console.log(`Problem 4 result --> `, get20s(artists));
...
console.log(`Problem 5 result --> `, removeArtist(artists, 0));
console.log(`Problem 5 result --> `, removeArtist(artists, 0));
console.log(`Problem 5 result --> `, removeArtist(artists, 0));
console.log(`Problem 5 result --> `, removeArtist(artists, 0));
console.log(`Problem 5 result --> `, removeArtist(artists, 0));
...
console.log(`Problem 6 result --> `, artists);
...
console.log(`Problem 7 result --> `, mostPainting(artists));
